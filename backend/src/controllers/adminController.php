...
class adminController
{
    ...
    public function __construct($conn)
    {
        ...
        $this->peliculaModelo = new Pelicula($this->conn);
    }
    ...
    public function listarDetallesPeliculas() {
        $this->authAdmin();
        $_SESSION['lista_peliculas'] = $this->peliculaModelo->listarPeliculasCompletas();
    }
}
