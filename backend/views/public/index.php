        ...
        <div id="carousel-peliculas" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/cinema-online-ticket/public/imgs/pelicula_imagen/banner/inception_banner.jpg" class="d-block w-100 img-carousel" alt="Portada Inception">
                ...
                <div class="carousel-item">
                    <img src="/cinema-online-ticket/public/imgs/pelicula_imagen/banner/avatar_banner.jpg" class="d-block w-100" alt="Portada Avatar">
                    <section class="capa">
                ...
                <div class="carousel-item">
                    <img src="/cinema-online-ticket/public/imgs/pelicula_imagen/banner/jocker_banner.png" class="d-block w-100 h-50" alt="Portada Jocker">
                    <section class="capa">
